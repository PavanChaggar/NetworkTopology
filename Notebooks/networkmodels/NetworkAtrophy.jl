...
# ╔═╡ 36d97d18-e04a-4d7d-858c-641134094b3f
pwd()
...
csv_path = "/Users/pavanchaggar/Projects/Connectomes/all_subjects"

# ╔═╡ 6c77c6b6-9215-11eb-1289-5558d371050e
subject_dir = "/Users/pavanchaggar/Projects/Connectomes/standard_connectome/scale1/subjects/"
...
md"""
κ = $(@bind κ Slider(0:0.05:3, show_value=true, default=0.5))

α = $(@bind α Slider(0.1:0.1:5, show_value=true, default=2.0))
...
begin 
	...
	fullsol = solve(prob, Tsit5(), saveat=0.1)
end;

# ╔═╡ 20b51026-921f-11eb-2fd0-8f7b3dbd8069
plot(fullsol, vars=(1:83), legend=false)

# ╔═╡ 6395656d-f336-4087-a2a8-8b5e4d9aadb7
plot(fullsol, vars=(84:166), legend=false)
...
# ╔═╡ 31a50073-04d8-4a81-825e-31cbc6c7ec0b
atrophy_data = data[84:end,:];

# ╔═╡ 922e3c32-22ea-48c1-ad32-601a860a3fc7
model = NetworkAtrophyPM(atrophy_data, prob);

# ╔═╡ 20164994-b115-49c4-8763-2886b121c4d3
prior_chain = sample(model, Prior(), 1_000);

# ╔═╡ c9acd07f-59ba-4c02-a5a3-966cf29fc44b
prior_chain

# ╔═╡ 626ce74f-9355-4074-9725-fe06e0e55b5a
mean(prior_chain[:σ])
...
plot_predictive(prior_chain, prob, sol, data)
...
# ╔═╡ af4119ef-f7e4-4a9c-9c10-d148e919cec9
plot_predictivenew(Array(chain), prob, sol, data, 27)
...
git-tree-sha1 = "19f26e1984fbc8a79705c6df50c319c7d2cb89e9"
...
git-tree-sha1 = "93f093369a964be73c44101700a0997e79129da5"
...
git-tree-sha1 = "55e195fe3e9f8db7a68ff41ce83c87d42771ec97"
...
git-tree-sha1 = "68d961d23c2155b4e8772a989bfe7a128c26875d"
