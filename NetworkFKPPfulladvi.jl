...
# ╔═╡ 525fde40-6d48-11eb-3c44-51dbe7df07f7
using Base.Threads
...
begin
	chain = sample(model, NUTS(.65), 5_000)
	plot(chain)
end

# ╔═╡ 7dc68738-6d47-11eb-2de1-e91054c02208
heatmap(cov(Array(chain)))

# ╔═╡ fe7a9268-6d4f-11eb-0bb4-ef02dbf0c5cf
mean(Array(chain), dims=1)
...
# ╔═╡ bfe665f6-6d75-11eb-256f-f729ad391002
q_sample = rand(q, 5_000);

# ╔═╡ d54bb162-6d75-11eb-118f-dd8823d0636b
heatmap(cov(q_sample'))

# ╔═╡ a228f738-6d76-11eb-1bd6-83a8f83f2f4a
begin 
...
# ╔═╡ b643f2b0-6d76-11eb-3cff-e5a331ba068e
begin 
...
# ╔═╡ 313d551c-6d50-11eb-36a3-b51150a62821
heatmap(cov(Array(samples), dims=2))

# ╔═╡ 8accd5f2-6c9a-11eb-22a1-115f3f00879c
begin 
	scatter(avg)
	scatter!(vcat([0.0], p,u0))
end
